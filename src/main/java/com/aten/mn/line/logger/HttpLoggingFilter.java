package com.aten.mn.line.logger;
...
public class HttpLoggingFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		try {
			...
			logMessage.append("[TIME USE:");
			logMessage.append(((System.currentTimeMillis()-startTime)/1000d)+"s");
			logMessage.append("] ");
			logMessage.append("[REQUEST PARAMETERS:");
			logMessage.append(requestMap);
			logMessage.append("] ");
			logMessage.append("[REQUEST BODY:");
			logMessage.append(bufferedRequest.getRequestBody(httpServletRequest.getServletPath()));
			logMessage.append("] ");
			logMessage.append("[REMOTE ADDRESS:");
			logMessage.append(httpServletRequest.getRemoteAddr());
			logMessage.append("] ");			
			logMessage.append("[RESPONSE:");
			logMessage.append(bufferedResponse.getContent());
			logMessage.append("] ");
			logger.info(logMessage.toString());
			MDC.remove("HeaderLogger");
		} catch (Exception e) {
	...
	HttpServletRequestWrapper {
		...
		public String getRequestBody(String path) throws IOException {
