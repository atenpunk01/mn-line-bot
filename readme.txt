 ...
 This will deploy two artifacts, target/NetworkMarketing.war and
 default-ds.xml.
 ...
 - http://localhost:8080/NetworkMarketing/
 ...
 Now you can either deploy the target/NetworkMarketing.war through the
 web-based GlassFish admininstration console, or you can again use asadmin:

  ./asadmin deploy target/NetworkMarketing.war

 To undeploy the application, run:

  ./asadmin undeploy NetworkMarketing
